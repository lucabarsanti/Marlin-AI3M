...
#define ANYCUBIC_PRINTER_BLTOUCH 0
...
#define STRING_CONFIG_H_AUTHOR "(lucabarsanti)" // Who made the changes.
...
#if ANYCUBIC_PRINTER_DRIVER == 1
  // driver TMC2208 con collegamenti originali (non invertiti)
...
#define G26_MESH_VALIDATION
  ...
  #define GRID_MAX_POINTS_X 5 // precedentemente 5
